...
SQL8="main/datadb/ordens_alertas.sql"
SQL9="main/datadb/imagens_perfil.sql"
SQL10="main/datadb/patrimonios.sql"
...
psql -h 127.0.0.1 -U "$DB_USER" -d "$DB_NAME" -f "$SQL8"
psql -h 127.0.0.1 -U "$DB_USER" -d "$DB_NAME" -f "$SQL9"
psql -h 127.0.0.1 -U "$DB_USER" -d "$DB_NAME" -f "$SQL10"
